...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // 50音を網羅したダミーデータのリスト（すべて user_id = 1 の顧客として登録）
        $dummyClients = [
            // あ行
            ...
            ['last_name' => '徳川', 'first_name' => '家康', 'last_name_kana' => 'tokugawa', 'first_name_kana' => 'ieyasu', 'last_name_kana' => 'とくがわ', 'first_name_kana' => 'いえやす', 'user_id' => 1],
            ...
            ['last_name' => '村上', 'first_name' => '春樹', 'last_name_kana' => 'むらかみ', 'first_name_kana' => 'ハルキ', 'last_name_kana' => 'むらかみ', 'first_name_kana' => 'ハルキ', 'last_name_kana' => 'むらかみ', 'first_name_kana' => 'はるき', 'user_id' => 1],
            
            // や・ら・わ行
            ['last_name' => '矢沢', 'first_name' => '永吉', 'last_name_kana' => 'やざわ', 'first_name_kana' => 'えいきち', 'user_id' => 1],
            ['last_name' => 'ルフィ', 'first_name' => 'モンキー', 'last_name_kana' => 'るふぃ', 'first_name_kana' => 'もんきー', 'user_id' => 1], // ら行
            ['last_name' => '和田', 'first_name' => 'アキ子', 'last_name_kana' => 'わだ', 'first_name_kana' => 'あきこ', 'user_id' => 1],
        ];

        // データベースに一件ずつ保存
        foreach ($dummyClients = $dummyClients as $clientData) {
